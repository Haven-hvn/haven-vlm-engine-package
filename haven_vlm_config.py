...
VLM_ENGINE_CONFIG = {
    ...
    "pipelines": {
        "video_pipeline_dynamic": {
            ...
            "output": "results",
            "version": 2.0,  # Version 2.0: Uses BinarySearchProcessor for optimized parallel VLM analysis
            "models": [
                {
                    "name": "video_analysis_pipeline",  # VLM-based video analysis using binary search optimization
                    "inputs": [
